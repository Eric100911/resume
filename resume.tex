...
\datedline{\textit{Bachelor Student} in Physics, expected July 2026}{GPA:3.78/4.00 (Major)}
...
\begin {itemize}
  ...
  \item Abroad Academic Research Program Fundin from Tsinghua University.
  \item Present talk at CMS BTV working group meeting ("Implementing GHS Algorithm in CMSSW for Jet Flavour Definition in NanoAOD Production", 12 Aug. 2025).
\end{itemize}
