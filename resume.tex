...
\basicInfo{
  ...
  \github[Eric100911]{github.com/Eric100911/} \textperiodcentered\
}
...
\datedline{\textbf{Comprehensive Excellence Scholarship}, Tsinghua University}{Nov. 2024}
\begin{itemize}
    \item Mitsubishi UFJ Foundation Scholarship Program 2024
\end{itemize}
\datedline{\textbf{Honorable Mention}, Interdisciplinary Contest in Modeling (ICM), COMAP}{Apr. 2024}
...
% Note: particle physics research experience. May need a good icon.

\section{\faicon{faBook}\ Research Experience}
\datedsubsection{\textbf{Search for Simultaneous Production of Double $J/\psi$ and $\Upsilon$ mesons \\ in Proton-Proton Collisions at 13.6 TeV}}{2024 -- Present}
...
\datedsubsection{\textbf{Big Data in Experimental Physics (1) \& (2)}, Tsinghua University}{2024}
