...
\datedline{\textit{Bachelor Student} in Physics, expected July 2026}{GPA:3.8/4.0 (Major)}
...
\begin {itemize}
  ...
  \item Presented a talk at the CMS BPH Production and Properties Meeting (9 Jul. 2025).
...
\begin {itemize}
  ...
  \item Presentation at the CMS BTV working group meeting (12 Aug. 2025).
  \item Presentation at the Qingli Academic Festival, Zhili College, Tsinghua University (15 Nov. 2025); awarded the "Dean's Award".
\end{itemize}
...
\begin{itemize}[parsep=0.5ex]
  ...
  \item \textbf{Languages}: English (proficient, CET4 675/710), Chinese (native), German (basic).
\end{itemize}
